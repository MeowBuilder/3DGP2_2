...
ID3D12RootSignature* CUIShader::CreateGraphicsRootSignature(ID3D12Device* pd3dDevice)
{
...
void CUIShader::CreateShader(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	if (!m_pd3dGraphicsRootSignature) CreateGraphicsRootSignature(pd3dDevice);

	m_nPipelineStates = 1;
	m_ppd3dPipelineStates = new ID3D12PipelineState * [m_nPipelineStates];

	CShader::CreateShader(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature);
